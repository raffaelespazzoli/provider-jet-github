...
export TERRAFORM_PROVIDER_VERSION := 4.28.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-github
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-github/4.28.0
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-github_4.28.0
